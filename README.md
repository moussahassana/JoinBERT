...
| ----- | ------ | --- | ---- | ------------- | ----------- |
| formIntentDataset  | 4,478  | 500 | 893  | 21            | 120         |
...
# For formIntentDataset
$ python3 main.py --task formIntentDataset \
                  --model_type bert \
                  --model_dir formIntentDataset_model \
                  --do_train --do_eval
```
...
| **formIntentDataset**  | BERT             | 97.87          | 95.59       | 88.24            |
